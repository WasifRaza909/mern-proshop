...
// We have to make static folder in order to use uploads folder
const __dirname = path.resolve();
// __dirname is used in old js and its not available in es modules so we have to make a variable like above to mimic it.
